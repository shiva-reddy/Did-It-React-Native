...
const ViewDetailedTask = ({ navigation, route }) => { 
    ...
    console.log(taskName+" "+taskDeadline+" "+taskDescription+" "+taskIsRecurring)
    ...
    return (
      <View style={[styles.container]}>
        ...
        <View style={[{flexDirection:'row', backgroundColor: '#EE2C38', marginTop:15}]}>
        <Text style={[{flex:5, backgroundColor: '#264653'},styles.headerStyle]}>{taskName}</Text>
        </View>
        <View style={[{flex: 1}, styles.elementsContainer]}>
            <View style={{flex: 3, backgroundColor: '#264653'}} >
            <View style={{flexDirection:'row', margin:10}}>
              <View style={{width:'50%', height: 50, backgroundColor: '#264653'}} >
              <MyAppText>
                <Text>Deadline</Text>
              </MyAppText>
              </View>
              <View style={{width:'40%', height: 50, backgroundColor: '#264653'}} >
              <MyAppText>
