...
const TakePhotoFromCamera = ({ navigation, route }) => { 
    ...
    return (
        <View style={[styles.container]}>
            <View style={[{flexDirection:'row', backgroundColor: '#264653', marginTop:15}]}>
                <MyAppText>
                <Text style={[{flex:5, backgroundColor: '#264653'},styles.headerStyle]}>Hey ! You may need to grant 
                 permissions from your phone</Text>
                </MyAppText>
            </View>
...
const CameraComponent = () => {
    ...
    return (
      <View style={{ flex: 1 }}>
          ...
          <Camera ref={ref => setCameraObject(ref)} 
                  style={{ flex: 1, margin:10 }} 
                  type={type} ratio={ratio}  
                  onCameraReady={onCameraReady}
                  useCamera2Api={true} >

          <View style={{flexDirection:"row",alignSelf:'center',margin:10, flex:1}}>
